...
export class BlogDetailComponent implements OnInit {
    singlePost: Blog; // then we add the variable to hold the singlePost
// constructor to inject the ActivatedRoute and Router 
    ...
    getSingle(id: string) { //method that takes an id as an argument, this could easily be done with ngFor
